...
class MockTurtleFactory : public TurtleFactory {
 public:
  ...
  // the above methods delegate to this util:
...
```cpp
  ...
  // When util calls ShareBuzz() on the MockBuzzer like this, the call is
...
TEST(FooTest, InvokesBarCorrectly) {
  MyMock mock;
  // Class MockFunction<F> has exactly util mock method.  It is named
  // Call() and has type F.
